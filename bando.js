class BandoScene extends Phaser.Scene {
  constructor() {
    super({ key: "BandoScene" });
  }
  ...
  createSketchfabContainer() {
    ...
    const embedHTML = `
      <div class="sketchfab-embed-wrapper">
        <iframe
          ...
          web-share
          src="https://sketchfab.com/models/d5156927e0984b63a0a216058f582592/embed"
          style="width: 100%; height: 500px; border: 0; position: relative; z-index: 9999;">
        </iframe>
        <p style="font-size: 13px; font-weight: normal; margin: 5px; color: #4A4A4A;">
          <a href="https://sketchfab.com/3d-models/baine-headbang-bugis-d5156927e0984b63a0a216058f582592?utm_medium=embed&utm_campaign=share-popup&utm_content=d5156927e0984b63a0a216058f582592"
             target="_blank" rel="nofollow" style="font-weight: bold; color: #1CAAD9;">
            Baine Headbang bugis
          </a> by
          <a href="https://sketchfab.com/akdesain?utm_medium=embed&utm_campaign=share-popup&utm_content=d5156927e0984b63a0a216058f582592"
             target="_blank" rel="nofollow" style="font-weight: bold; color: #1CAAD9;">
            akdesain
          </a> on
          <a href="https://sketchfab.com?utm_medium=embed&utm_campaign=share-popup&utm_content=d5156927e0984b63a0a216058f582592"
             target="_blank" rel="nofollow" style="font-weight: bold; color: #1CAAD9;">
            Sketchfab
          </a>
        </p>
    ...
    this.add
      .text(this.scale.width / 2, 40, "Pakaian Adat Bugis - Bando", {
        fontSize: "32px",
        fontFamily: "Arial",
        color: "#333333",
        align: "center",
    ...
    this.add
      .text(
        this.scale.width / 2,
        90,
        "Bando adalah hiasan kepala tradisional Bugis",
        {
          fontSize: "16px",
          fontFamily: "Arial",
          color: "#666666",
...
export default BandoScene;

// Export untuk digunakan di main.js
// game.scene.add('BandoScene', BandoScene);
