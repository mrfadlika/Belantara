...
class Level1Chapter2 extends Phaser.Scene {
  constructor() {
    super({ key: "Level1Chapter2" });
  ...
  create() {
    ...
    // Container untuk menampilkan aksara yang dipilih (di tengah kotak kiri)
    ...
    const startBtnX = leftBoxCenterX - totalGridWidth / 2;
