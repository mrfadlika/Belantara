class BajuBodoScene extends Phaser.Scene {
  constructor() {
    super({ key: "BajuBodoScene" });
  }
  ...
  createSketchfabContainer() {
    ...
    const embedHTML = `
      <div class="sketchfab-embed-wrapper">
        <iframe
          title="Baju Adat Sulawesi Selatan"
          frameborder="0"
          allowfullscreen
          ...
          web-share
          src="https://sketchfab.com/models/3bf4b1c0094e4ca99a9e02583dcdbab7/embed"
          style="width: 100%; height: 500px; border: 0; position: relative; z-index: 9999;"
        >
        </iframe>
        <p style="font-size: 13px; font-weight: normal; margin: 5px; color: #4A4A4A;">
          <a href="https://sketchfab.com/3d-models/baju-adat-sulawesi-selatan-3bf4b1c0094e4ca99a9e02583dcdbab7?utm_medium=embed&utm_campaign=share-popup&utm_content=3bf4b1c0094e4ca99a9e02583dcdbab7"
             target="_blank" rel="nofollow" style="font-weight: bold; color: #1CAAD9;">
            Baju Adat Sulawesi Selatan
          </a> by
          <a href="https://sketchfab.com/jamillaags?utm_medium=embed&utm_campaign=share-popup&utm_content=3bf4b1c0094e4ca99a9e02583dcdbab7"
             target="_blank" rel="nofollow" style="font-weight: bold; color: #1CAAD9;">
            jamillaags
          </a> on
          <a href="https://sketchfab.com?utm_medium=embed&utm_campaign=share-popup&utm_content=3bf4b1c0094e4ca99a9e02583dcdbab7"
             target="_blank" rel="nofollow" style="font-weight: bold; color: #1CAAD9;">
            Sketchfab
          </a>
        </p>
    ...
    this.add
      .text(this.scale.width / 2, 40, "Pakaian Adat Bugis - Baju Bodo", {
        fontSize: "32px",
        fontFamily: "Arial",
        color: "#333333",
        align: "center",
