class Chapter1 extends Phaser.Scene {
  ...
  preload() {
    this.load.image("chapter1bg", "assets/bg.png");
    this.load.image("buttonHomeUngun", "assets/button home.png");
    this.load.image("topJudul", "assets/button chapter 1.png");
    this.load.image("chapter1Level1", "assets/button level 1.png");
    this.load.image("chapter1Level2", "assets/button level 2.png");
    this.load.image("chapter1Level3", "assets/button level 3.png");
    this.load.image("chapter1Level4", "assets/button level 4.png");
    this.load.image("chapter1Level5", "assets/button level 5.png");
    this.load.image("chapter1Level6", "assets/button level 6.png");
  ...
  create() {
    ...
    const chapter1bg = this.add.image(0, 0, "chapter1bg").setOrigin(0, 0);
    this.resizeImage(chapter1bg);
    ...
    for (let i = 0; i < 6; i++) {
      ...
      const btnKey = `chapter1Level${i + 1}`;
      const btn = this.createButton(x, y, btnKey, buttonSound, () => {
        ...
        if (hearts > 0) {
          this.scene.start("Level1Chapter1");
        } else {
          // Tampilkan pop up hati habis di Chapter1
